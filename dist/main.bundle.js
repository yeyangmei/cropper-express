...
var _cropperjs = __webpack_require__(1);
...
(0, _jquery2.default)('.tijiao').click(function () {
  _jquery2.default.ajax({
    method: 'post',
    url: 'http://localhost:2733/process_post',
    data: JSON.stringify({ first_name: (0, _jquery2.default)('.nameInput').val(), last_name: (0, _jquery2.default)('.nameInputLast').val() }),
...
(0, _jquery2.default)('.showBox').click(function () {
  (0, _jquery2.default)('.editPhoto').show();
});
var info = {};
...
var arr = [];
var cropper = new _cropperjs2.default(image, {
  aspectRatio: 16 / 9,
  ready: function ready(e) {
    ...
    arr.forEach(function (x) {
      return (0, _jquery2.default)(x).remove();
    }); // 把跟arr数组里面相同的node节点都删除
    arr = [];
    (0, _index2.default)(previews, function (elem) {
      console.log(elem);
...
(0, _jquery2.default)('#uploadImage').change(function () {
...
(0, _jquery2.default)('.photoSubmit').click(function () {
  _jquery2.default.ajax({
    method: 'post',
...
(0, _jquery2.default)('#myhead').change(function () {
  (0, _jquery2.default)('#percentWrap').css('display', 'flex');
